  ...
  return (
    <section className="bg-[rgb(22,22,63)]">
        <div className="xm:flex xm:justify-center inline">
            ...
            <div className="md:flex md:justify-around md:mx-48 md:pb-28 text-white block">
                <div className="text-center">
                    <p className="text-6xl font-bold xm:text-5xl">15</p>
                    <p className="xm:text-sm">years of experience</p>
                </div>
                ...
                <div className="text-center">
                    <p className="text-6xl font-bold xm:text-5xl">36</p>
                    <p  className="xm:text-sm">Qualified Expert</p>
                </div>
                <div className="md:pt-9">
                    <div datatestid="svgRoot-comp-kq5dfsfl1" className="_3bLYT _2OIRR gNsvg">
                        <svg preserveAspectRatio="none" data-bbox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 200 200" role="presentation" aria-hidden="true" >
                ...
                <div className="text-center">
                    <p className="text-6xl font-bold xm:text-5xl ">120</p>
                    <p  className="xm:text-sm">Client Every Year</p>
                </div>
                <div className="md:pt-9">
                    <div datatestid="svgRoot-comp-kq5dfsfl1" className="_3bLYT _2OIRR gNsvg">
                        <svg preserveAspectRatio="none" data-bbox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 200 200" role="presentation" aria-hidden="true">
                ...
                <div className="text-center ">
                    <p className="text-6xl font-bold xm:text-5xl ">9</p>
                    <p  className="xm:text-sm md:pb-0 pb-[68px]">Intl.Partner</p>
                </div>
             </div>
    </section>
  )
