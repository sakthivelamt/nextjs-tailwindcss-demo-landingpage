...
interface goodNumberProps{
    datatestid:any;
    goodWithNumber:{
        data:{
            good_in_number:any;
            experience:{
                years_of_experience_number:any;
                years_of_experience_para:any;
            id:any
            }[];
        }
...
const Goodnumber = ({goodWithNumber}:goodNumberProps) => {
            ...
            <div className="md:flex text-white block md:pb-[120px]">
              <div className="text-center w-full md:px-[150px]">
                  ...
                  <div  className="md:flex md:justify-evenly"> {goodWithNumber.data.experience.map((post, id) => <div key={id} className="md:flex md:justify-between text-white block md:w-[200px]" >
                      ...
                      {id!==3 && <div className="md:pt-9 md:ml-[5%]">
                          <div className="_3bLYT _2OIRR gNsvg">
